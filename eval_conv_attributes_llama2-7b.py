...
def save_to_db(user_responses, start_time, elapsed_seconds):
    try:
        ...
        with conn.cursor() as cur:
            cur.execute("""
                CREATE TABLE IF NOT EXISTS rater_evaluations_llama_2_7b_chat_gpt_4_0613 (
            ...
            insert_query = """
                INSERT INTO rater_evaluations_llama_2_7b_chat_gpt_4_0613
...
def main():
    ...
    if "df_local" not in st.session_state:
        try:
            st.session_state["df_local"] = pd.read_csv("llama-2-7b-chat-gpt-4-0613-conversations.csv")
